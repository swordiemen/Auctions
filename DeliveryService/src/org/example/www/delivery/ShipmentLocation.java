 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                Namespace URI = http://www.example.org/Delivery/
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for PersonEmail
                        */

                        
                                    protected java.lang.String localPersonEmail ;
                           ...
                           */
                           public  java.lang.String getPersonEmail(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param PersonEmail
                               */
                               public void setPersonEmail(java.lang.String param){
                            
                                            this.localPersonEmail=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":shipmentLocation",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "shipmentLocation",
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "";
                                    writeStartElement(null, namespace, "personEmail", xmlWriter);
                             

                                          if (localPersonEmail==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("personEmail cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localPersonEmail);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("",
                                        ...
                                        if (localPersonEmail != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPersonEmail));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("personEmail cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static ShipmentLocation parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"shipmentLocation".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ShipmentLocation)org.example.www.auction.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","personName").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"personName" +"  cannot be null");
                                    }
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","personEmail").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"personEmail" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setPersonEmail(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
